...
function Hero() {
  ...
  return (
    <section id="hero" className="flex items-center justify-center min-h-screen relative overflow-hidden pt-16 pb-16">
      <div className="absolute inset-0 opacity-10 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCI+CjxyZWN0IHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCIgZmlsbD0ibm9uZSIvPgo8cGF0aCBkPSJNMCAxMEwwIDAgTCAxMCAwIiBmaWxsPSJub25lIiBzdHJva2U9IiNGRkQ3MDAiIHN0cm9rZS11aWR0aD0iMC41Ii8+Cjwvc3ZnPg==')]"></div>
